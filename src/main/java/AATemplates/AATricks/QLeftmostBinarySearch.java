...
public class QLeftmostBinarySearch {
   class Q34FindFirstAndLastPositionOfElementInSortedArray{
    ...
    @Test
    public void test() {
        Q34FindFirstAndLastPositionOfElementInSortedArray q = new Q34FindFirstAndLastPositionOfElementInSortedArray();
